...
export default function BottomNav({ activeTab, setActiveTab }) {
    ...
    const navItems = [
        { id: 'home', icon: '/home.png', label: 'Agent' },
        { id: 'dataCenter', icon: '/bottomnaveai.png', label: 'Data center' },
        { 
            id: 'SPAI', 
        ...
        { id: 'invite', icon: '/bottomnavinvite.png', label: 'Invite' },
        { id: 'task', icon: '/bottomnavetask.png', label: 'Task' },
    ];
