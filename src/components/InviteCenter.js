        ...
        <div className="relative z-10">
          ...
          <div className="relative mb-8 h-48 flex items-center justify-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              {/* Large Blue User Icon */}
              <motion.div
                className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center mb-4 shadow-2xl"
                style={{
                  filter: 'drop-shadow(0 20px 40px rgba(59, 130, 246, 0.3))'
                }}
              >
                <IoPeople className="text-white" size={40} />
              </motion.div>
              
              {/* Smaller White User Icon */}
              <motion.div
                className="absolute -left-8 top-8 w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-xl"
                animate={{
                  y: [0, -8, 0],
                  x: [0, 3, 0],
              ...
              >
                <BiUserPlus className="text-gray-600" size={24} />
              </motion.div>
              
              {/* Paper Plane */}
              <motion.div
                className="absolute -right-6 top-12 text-blue-400"
                animate={{
                  x: [0, 10, 0],
                  y: [0, -5, 0],
                  rotate: [0, 15, 0],
