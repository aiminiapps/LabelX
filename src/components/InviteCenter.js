    ...
    <div className="text-white overflow-hidden">
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="relative mb-8 flex items-center justify-center">
                <Image src='/counter.png' alt='Character' width={500} height={500} quality={80}/>
        </div>
        ...
        <div className="glass rounded-xl p-6 mb-6">
          <div className="text-center mb-4">
            ...
            <div className="bg-slate-600/50 rounded-lg p-3 border border-gray-600/50">
              <div className="font-mono text-xl text-cyan-400 tracking-wider">{inviteCode}</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="glass-light glass-dark w-full text-white font-semibold py-2.5 px-6 rounded-xl transition-all duration-200 transform"
          >
            <div className="flex items-center justify-center space-x-2">
              {copySuccess ? (
                <>
